  ...
  Readmore.prototype = {
    ...
    init: function() {
      ...
      $(this.element).each(function() {
        ...
        if(current.height() <= maxHeight + heightMargin) {
          ...
          var useClass = $this.options.startOpen ? $this.options.lessClass : $this.options.moreClass;
          current.find('.readmore-js-toggle').on('tap', function(event)
          {
    ...
    toggleSlider: function(trigger, element, event)
    {
      ...
      if ($(element).height() <= collapsedHeight) {
        ...
        newClass = this.options.lessClass;
        expanded = true;
        ...
        newClass = this.options.moreClass;
      ...
      $(element).animate({'height': newHeight}, {duration: $this.options.speed, complete: function() {
          ...
          $(trigger).removeClass().addClass(newClass).on('tap', function(event)
          {
